...
namespace BankAccountNS
{
        ...
        public const string CreditAccountFrozenMessage = "Account is frozen";
        ...
        public void Credit(double amount)
        {
            if (m_frozen)
            {
                throw new ArgumentOutOfRangeException("Account frozen", amount, CreditAccountFrozenMessage);
            }
